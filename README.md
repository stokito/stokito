...
Some useful projects that I am developing, maintaining or contributed:

* [Spark IM](https://github.com/igniterealtime/Spark) XMPP messenger for organizations.
* IntelliJ Idea plugins
  ...
  * [Singleton Inspection](https://github.com/stokito/IdeaSingletonInspection) - a simple plugin with inspection for a Singleton pattern. Useful to learn how to make inspections.
* Self-hosting
  * [Yurt Page](https://github.com/yurt-page/docs) - a self-hosting at home on cheapest devices like a router.
...
* [deflate](https://github.com/stokito/deflate) - a utility to compress to Deflate instead of gzip.
* [Ubuntu PPA with OpenWrt programs](https://github.com/stokito/openwrt-ubuntu)
* [Pidgin FChat plugin](https://github.com/stokito/pidgin-fchat) - a suckless serverless UDP-based chat messenger for a local network.
...
* [LinkedIn](https://www.linkedin.com/in/stokito/) feel free to add me on the LinkedIn.
...
* XMPP (Jabber): [stokito@conversations.im](https://xmpp.link/#stokito@conversations.im)
